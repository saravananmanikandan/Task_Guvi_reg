        ...
        <div class="row">
            <div class="col-lg-4 col-md-10 col-sm-10 col-10 justify-content-center text-center form-card">
                ...
                <form action="" method="post" class="form" id="register-form">
                    ...
                    <div class="form-group">
                        <input type="date" name="" id="email" class="form-control" placeholder="Enter email" data-rule="email" data-msg="Please enter your email address">
                        <div class="validation text-left text-danger"></div>
                    </div>
                    <div class="form-group">
                        <input type="text" name="phno" id="phno" class="form-control" placeholder="Enter Phone no" data-rule="minlen:10" data-msg="Please enter your phone number">
                        <div class="validation text-left text-danger"></div>
                    </div>
                    <div class="form-group">
